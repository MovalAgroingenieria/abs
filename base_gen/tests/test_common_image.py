...
class TestCommonImage(TransactionCase):
    ...
    def test_merge_img_returns_base64(self):
        ...
        out = self.ImageHelper.merge_img(
            bg, fg, format_output_img="PNG", return_base64=True
        )
        self.assertTrue(out)
    ...
    def test_merge_img_fit_foreground_keep_aspect(self):
        ...
        out_b64 = self.ImageHelper.merge_img(
            bg, fg, fit_foreground=True, keep_aspect=True
        )
    ...
    def test_dump_jpeg_flattens_alpha(self):
        ...
        out_b64 = self.ImageHelper.merge_img(
            bg, fg, format_output_img="JPEG", return_base64=True
        )
        data = base64.b64decode(out_b64.encode("ascii"))
        im = Image.open(io.BytesIO(data))
