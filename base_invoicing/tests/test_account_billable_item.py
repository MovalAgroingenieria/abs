...
class TestAccountBillableItem(TransactionCase):
    ...
    def test_inherits_from_account_billable_item_false_for_unknown(self):
        self.assertFalse(self.Billable.inherits_from_account_billable_item("non.existent.model"))
